...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>bcrypt</b> with <b>at.favre.lib:bcrypt</b> coordinates and
     * with version reference <b>bcrypt</b>
     * <p>
    ...
    public static class KotlinxSerializationLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>serialization.json</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class KtorSerializationKotlinxLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>json</b> with <b>io.ktor:ktor-server-serialization-kotlinx-json</b> coordinates and
    ...
    public static class MongodbLibraryAccessors extends SubDependencyFactory {
        private final MongodbBsonLibraryAccessors laccForMongodbBsonLibraryAccessors = new MongodbBsonLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>mongodb.bson</b>
         */
        public MongodbBsonLibraryAccessors getBson() {
            return laccForMongodbBsonLibraryAccessors;
        }
    ...
    public static class MongodbBsonLibraryAccessors extends SubDependencyFactory {

        public MongodbBsonLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>kotlin</b> with <b>org.mongodb:bson-kotlin</b> coordinates and
         * with version reference <b>mongodb</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKotlin() {
            return create("mongodb.bson.kotlin");
        }
    ...
    public static class MongodbKotlinLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>coroutine</b> with <b>org.mongodb:mongodb-driver-kotlin-coroutine</b> coordinates and
         * with version reference <b>mongodb</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCoroutine() {
            return create("mongodb.kotlin.coroutine");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>bcrypt</b> with value <b>0.10.2</b>
         * <p>
        ...
        /**
         * Version alias <b>mongodb</b> with value <b>5.2.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.serialization</b>
         */
    ...
    public static class SerializationVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>serialization.json</b> with value <b>1.7.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJson() { return getVersion("serialization.json"); }
